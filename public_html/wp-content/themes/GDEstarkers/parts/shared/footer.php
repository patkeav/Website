			<footer id="site-footer" role="contentinfo">
				...
				<f><h1> Copyright </h1><br />
					<p><small>&copy; <?php echo date('Y'); ?> <?php bloginfo('title'); ?><?php bloginfo('description'); ?>. Built on <a href="http://wordpress.org" rel="external" target="_blank">WordPress</a> &amp; the <a href="http://leonpaternoster.com/wp-themes" rel="external" target="_blank">Scherzo theme</a> by<br /> Leon Paternoster.</small></p></f>
				<f id="widget" >
